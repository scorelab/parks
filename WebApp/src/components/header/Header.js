    ...
    <AppBar position="fixed" className={classes.appBar}>
      <Toolbar>
        ...
        <Typography
          ...
          gutterBottom
        >
          Sri Lankan National Parks - Administrator
        </Typography>
        <Menu
          id="simple-menu"
          anchorEl={anchorEl}
          ...
          onClose={handleClose}
        >
          <MenuItem onClick={handleClickOpenDialog}>Reset Password</MenuItem>
        ...
        >
          ...
          >
            ...
            <Grid item xs={12}>
              ...
              collaboration of Department of Wild Life conservation for animal
